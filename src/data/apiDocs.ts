    ...
    endpoints: [
      {
        ...
        notes: [
          'ready becomes true after WhatsApp initializes (~20s warmup on cold start).',
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        auth: true,
        response: { success: true, qr: '2@...', apiBuild: '2026-06-02-v3' },
      },
      {
        id: 'reset-session',
        method: 'POST',
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        response: { success: true, successCount: 1, total: 1, results: [] },
      },
      {
        id: 'send-media',
        method: 'POST',
      ...
      },
      {
        id: 'message-history',
        method: 'GET',
        path: '/api/messages?accountId=&status=&limit=50',
        title: 'Message history',
        description: 'List stored outbound messages for the authenticated user.',
        auth: true,
        response: { success: true, messages: [], total: 0 },
      },
      {
        id: 'message-stats',
        method: 'GET',
...
export const DOC_ERRORS = [
  ...
  },
  {
    code: '4xx/5xx',
    title: 'Error body',
    detail: 'Most errors return JSON with error or message. Example: { "success": false, "error": "..." }',
  },
]
