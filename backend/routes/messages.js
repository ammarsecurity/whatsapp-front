...
const { requireLicenseForAccount } = require('../middleware/requireAccountLicense');
...
router.post('/send', requireLicenseForAccount, async (req, res) => {
  try {
...
router.post('/send-media', requireLicenseForAccount, upload.single('file'), async (req, res) => {
